...
{
    public class SharedNameVariables : LocalNameVariables
    {
        protected override void Awake()
        {
            // Get the field info for m_Runtime
            var fieldInfo = typeof(LocalNameVariables).GetField("m_Runtime", BindingFlags.Instance | BindingFlags.NonPublic);
            ...
            var methodInfo =
                typeof(LocalNameVariables).GetMethod("OnRuntimeChange", BindingFlags.Instance | BindingFlags.NonPublic);
            if (methodInfo == null)
            {
